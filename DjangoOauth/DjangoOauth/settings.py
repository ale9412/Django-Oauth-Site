...
SECRET_KEY = '31r+umph=i5te@ugz66*_t0@cv5(^j_d!+$_d(sh)$e13l7&&s'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'django_oauth.sqlite3'),
    }
}
...
SOCIAL_AUTH_FACEBOOK_KEY = '393952701155889'
SOCIAL_AUTH_FACEBOOK_SECRET = 'b4779ba6ee62f25e9beac380dfade0c3'
